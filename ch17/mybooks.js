...
var DBName = "myBooks",DBVersion = 1; //定义数据库名称和版本号
var bookLists = [{		title: "Web前端开发技术-Html、Css、JavaScript",
		author: "储久良",		isbn: "9787302431695"	},
	{	title: "计算机组成原理(修订版)",		author: "张功萱",
		isbn: "9787302433637"	},
	{	title: "HTML/CSS/JavaScript标准教程",
		author: "本书编委会",		isbn: "9787121079344"	},
	{	title: "HTML+CSS网页设计与布局从入门到精通",
		author: "温谦",		isbn: "9787115183392"	},
	{	title: "Java 2实用教程(第5版)",
		author: "耿祥义",		isbn: "9787302464259 "	}];
//3.2 浏览器的支持判断
